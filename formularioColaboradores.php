...
$anio = $_POST["year"];
$titulo = $_POST["titulo"];
$universidad1 = $_POST["universidad1"];
// $maestria = $_POST["maestria"];
// $universidad2 = $_POST["universidad2"];
// $doctorado = $_POST["doctorado"];
// $universidad3 = $_POST["universidad3"];
...
"<br>Año: " . $anio .
"<br>Título: " . $titulo .
"<br>Universidad Título: " . $universidad1 .
"<br>Mensaje: " . $mensaje .
"<br>Scopus: " . $scopus .
"<br>Researchgate: " . $researchgate .
"<br>Orcid: " . $orcid .
"<br>Correo: " . $correo .
"<br>Teléfono: " . $telefono .
"<br>Extensión: " . $extension.
"</body>
</html>";
...
$header['Subject'] = 'Información Colaboradores';
...
*/
header('Location: https://ikiam.edu.ec/agradecimiento.html#1');
?>